...
export interface Exercise {
  ...
  // 'up' means the hold position is at the larger angle (e.g. Plank straight body > 160)
  // 'down' means the hold position is at the smaller angle (e.g. Wall Sit bent knees < 110)
  holdPhase?: 'up' | 'down'; 
  cameraFacing?: 'front' | 'side'; // New property to guide user positioning
