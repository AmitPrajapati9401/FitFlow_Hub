...
// Using consistent functional component pattern to fix IntrinsicAttributes errors
interface IconProps {
  className?: string;
}
...
export const StartIcon = ({ className }: IconProps) => (
...
export const LoadingIcon = ({ className }: IconProps) => (
    <svg className={className ?? "animate-spin h-6 w-6"} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
export const CameraOffIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "h-16 w-16"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const FitFlowLogo = ({ className, lightText = false }: { className?: string; lightText?: boolean }) => {
    const textColor = lightText ? "#FFFFFF" : "#111827";
    return (
        <div className={`flex items-center gap-3 h-10 ${className}`}>
            <svg className="w-8 h-8 flex-shrink-0" viewBox="0 0 24 24" fill={textColor}>
...
export const DumbbellIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "h-6 w-6"} viewBox="0 0 20 20" fill="currentColor">
      <path d="M5 4a1 1 0 00-2 0v7.268a2 2 0 000 3.464V16a1 1 0 102 0v-1.268a2 2 0 000-3.464V4zM11 4a1 1 0 10-2 0v1.268a2 2 0 000 3.464V16a1 1 0 102 0V8.732a2 2 0 000-3.464V4zM16 3a1 1 0 011 1v7.268a2 2 0 010 3.464V16a1 1 11-2 0v-1.268a2 2 0 010-3.464V4a1 1 0 011-1z" />
    </svg>
);
...
export const OldSettingsIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "w-full h-full"} viewBox="0 0 24 24" fill="currentColor">
...
export const NavPlanIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "w-full h-full"} viewBox="0 0 24 24" fill="currentColor">
...
export const NavProgressIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "w-full h-full"} viewBox="0 0 24 24" fill="currentColor">
...
export const NavSettingsIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "w-full h-full"} viewBox="0 0 24 24" fill="currentColor">
...
export const CyclingIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "w-6 h-6"} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12,2C13.1,2 14,2.9 14,4C14,5.1 13.1,6 12,6C10.9,6 10,5.1 10,4C10,2.9 10.9,2 12,2M15.58,11.81L18.25,16H15.5L14,14.5L11.5,17L9.5,15L6.25,18.25L5.75,17.75L9,14.5L11,16.5L13.5,14L14.04,12.25L12,11L11.45,9H9.5V7H12.25L13.56,9.53L15.58,11.81M6,20A2,2 0 0,0 4,22A2,2 0 0,0 6,24A2,2 0 0,0 8,22A2,2 0 0,0 6,20M6,20A2,2 0 0,0 4,22A2,2 0 0,0 6,24A2,2 0 0,0 8,22A2,2 0 0,0 6,20M18,20A2,2 0 0,0 16,22A2,2 0 0,0 18,24A2,2 0 0,0 20,22A2,2 0 0,0 18,20Z" />
    </svg>
);
...
export const FlameIcon = ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "w-6 h-6"} style={style} viewBox="0 0 24 24" fill="currentColor">
...
export const ShieldCheckIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.13-2.054-.382-3.016z" />
  </svg>
);
...
export const MoonIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "w-6 h-6"} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.1,22c-4.1,0-7.8-2.6-9.1-6.6c-0.1-0.3,0-0.6,0.3-0.8c0.3-0.2,0.6-0.1,0.8,0.1c1.5,1.1,3.4,1.7,5.2,1.7 c4.7,0,8.5-3.8,8.5-8.5c0-1.8-0.6-3.6-1.7-5.1C16,2.5,16,2.2,16.2,1.9c0.2-0.3,0.5-0.4,0.8-0.3c4,1.4,6.6,5.1,6.6,9.2 C23.6,16.4,18.4,22,12.1,22z"/>
    </svg>
);

export const WaterIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "w-6 h-6"} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12,20C14.2,20 16,18.2 16,16C16,13.8 14.2,12 12,12C9.8,12 8,13.8 8,16C8,18.2 9.8,20 12,20z M12,4 c-3.3,0-6,2.7-6,6c0,3.3,6,10,6,10s6-6.7,6-10C18,6.7,15.3,4,12,4z"/>
    </svg>
);

// Added TimerIcon, HistoryIcon, and ActivityIcon to fix ProgressDashboard import errors
...
export const HistoryIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className ?? "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.05 11a9 9 0 11.5 4m-.5 5v-5h5" />
  </svg>
);
